...
class ProfileSettingsScreen extends ConsumerWidget {
            ...
            _Section(
              ...
              children: [
                ...
                _SettingsRow(
                  ...
                  onTap: profile.isGoogleConnected
                      ? null
                      : () => _showAccountHint(context),
                  showChevron: false,
                ),
              ],
            ),
            ...
            _Section(
              ...
              children: [
                ...
                const _SettingsRow(
                  ...
                  label: 'ASTRA Memory',
                  value: 'Local-first memory engine',
                  showChevron: false,
                ),
              ],
            ),
            ...
            _Section(
              ...
              children: [
                _SettingsRow(
                  ...
                  value: profile.isGoogleConnected ? 'Connected via Google' : 'Connect when needed',
                  showChevron: false,
                ),
                _SettingsRow(
  ...
  Future<void> _editNickname(BuildContext context, WidgetRef ref, String existing) async {
    ...
    await ref.read(astraProfileProvider.notifier).setNickname(nickname);
  }

  void _showAccountHint(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Google sign-in is available from the account screen.')),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  profile.email.isEmpty ? 'Local ASTRA profile' : profile.email,
                  maxLines: 1,
...
class _ReminderReadinessRow extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return FutureBuilder<ReminderReadinessState>(
      ...
      builder: (context, snapshot) {
        ...
        Color color = AstraColors.textMuted;
        if (readiness != null) {
          switch (readiness) {
